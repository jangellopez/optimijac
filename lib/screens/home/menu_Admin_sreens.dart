...
class Menu_Admin extends StatefulWidget {
  ...
  Menu_Admin(this.email, this.rolIdentificado, {Key? key}) : super(key: key);
  ...
  Widget drawerList() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          menuItem(1, "Gestion Comunas", Icons.house_rounded,
              currentPage == DrawerSections.consultarComunas ? true : false),
          menuItem(2, "Gestion Presidentes", Icons.person_search,

...
class ConsultaSolicitudes extends StatefulWidget {
  ConsultaSolicitudes({Key? key}) : super(key: key);

  @override
  State<ConsultaSolicitudes> createState() => _ConsultaSolicitudesState();
}

class _ConsultaSolicitudesState extends State<ConsultaSolicitudes> {
  final _auth = FirebaseAuth.instance;
  TextEditingController _searchview = TextEditingController();
  //lista de habitanes
  List<ConsultaSolicitudes> habitantes = [];
...
Future<List<Solicitud>> getAll() async {
  var snapshot = await FirebaseFirestore.instance.collection('Solicitud').get();

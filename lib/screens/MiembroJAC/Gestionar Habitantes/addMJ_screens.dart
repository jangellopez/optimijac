...
class addMJ extends StatefulWidget {
  addMJ({Key? key}) : super(key: key);

  @override
  State<addMJ> createState() => _addMJState();
}

class _addMJState extends State<addMJ> {
  final _auth = FirebaseAuth.instance;
  TextEditingController _searchview = TextEditingController();
  //lista de habitanes
  List<addMJ> habitantes = [];
            ...
            child: new Center(
                child: StreamBuilder(
                    stream: FirebaseFirestore.instance
                        ...
                        .where('rRol', isEqualTo: 'HABITANTE')
